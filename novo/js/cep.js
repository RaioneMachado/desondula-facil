$(document).ready(function () {
  ...
  $("#inf_field_ZipFour1").blur(function () {
    ...
    if ("" != e) {
      /^[0-9]{8}$/.test(e)
        ? ($.getJSON(
            "https://viacep.com.br/ws/" + e + "/json/?callback=?",
            function (a) {
              if ("erro" in a)
                Swal.fire({
                  ...
                  a.value
                    ? $("#inf_field_ZipFour1").val("")
                    : ($("#rua").prop("disabled", !1),
                      $("#numero").prop("disabled", !1),
                      $("#bairro").prop("disabled", !1),
          ...
          $("#inf_field_StreetAddress1").prop("disabled", !1),
          $("#inf_field_StreetAddress2").prop("disabled", !1))
        : (a(), alert("Formato de CEP inválido."));
    } else a();
  });
});
