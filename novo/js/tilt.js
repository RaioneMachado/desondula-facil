    ...
    (t.fn.tilt = function (i) {
      const s = function () {
        ...
        l = function () {
          ...
          (t(this).css(
            "transform",
            `perspective(${this.settings.perspective}px) rotateX(${"x" === this.settings.disableAxis ? 0 : this.transforms.tiltY}deg) rotateY(${"y" === this.settings.disableAxis ? 0 : this.transforms.tiltX}deg) scale3d(${this.settings.scale},${this.settings.scale},${this.settings.scale})`,
          ),
            this.settings.glare &&
              (this.glareElement.css(
                "transform",
              ...
              (t(this).data("settings", this.settings),
                ...
                function () {
                  (t(this).on("mousemove", h),
                    ...
                    this.settings.glare &&
                      t(window).on("resize", g.bind(this)));
                }.call(this));
            }),
            this.init());
        })
